...
A telepítés után az RStudioban található **Knit** gombra való kattintással máris generálhatjuk a dokumentumunkat, ami nemcsak a kérdésekre adott válaszainkat, de az elemző kódot is tartalmazza majd.

A házi feladatokat a novemberi meetupot megelőző nap délig lehet beküldeni az agi@rladies.org címre. Nemcsak teljes, de elkezdett házi feladatok is beküldhetők.
...
Tegyük fel, hogy egy foglalási gyűjtőoldal (Hotels.com, Bookings.com, Airbnb stb.) elemzői csapatában dolgozunk. A felhasználói kommunikációért felelős csapat két különböző e-mail ötletet kapott a desginerektől és szeretnék megtudni, melyik e-mail típus tetszene jobban a felhasználóknak, melyikre kattintanának többet, melyik öszönözné őket jobban vásárlásra stb.
...
A mi feladatunk kielemezni az adatsort és a benne található információk alapján kitalálni, melyik e-mail típus sikeresebb és milyen típusú felhasználók körében.
